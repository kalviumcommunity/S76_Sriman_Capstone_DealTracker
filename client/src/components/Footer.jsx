...
const Footer = () => {
  return (
    <footer 
      ...
      style={{
        background: 'linear-gradient(to right, #472C6C 0%, #472C6C 50%, #472C6C 75%, #472C6C 100%)',
    ...
    >
      <div className="container mx-auto py-12">
        <div className="flex justify-between items-start px-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5l9 9m0 0l9-9"/>
                </svg>
          ...
          {/* Right side */}
          <div className="text-white flex flex-col items-end gap-6">
